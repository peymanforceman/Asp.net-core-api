...
namespace Common.Utilities
{
    ...
    {
        /// <summary>
        /// Singularising table name like Posts to Post or People to Person
        /// </summary>
        /// <param name="modelBuilder"></param>
        public static void AddSingularisingTableNameConvention(this ModelBuilder modelBuilder)
        {
        ...
        /// </summary>
        /// <param name="modelBuilder"></param>
        /// <param name="tBaseType">Base type that Entities inherit from this</param>
        /// <param name="assemblies">Assemblies contains Entities</param>
